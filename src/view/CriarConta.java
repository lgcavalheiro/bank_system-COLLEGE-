...
public class CriarConta extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	case 0:
        	...
        	System.out.printf("%s - %s - %s", String.valueOf(novaConta.getNumero()),
        			String.valueOf(novaConta.getSaldo()),
        			String.valueOf(novaConta.getTaxaDeOperacao()));
    		break;
    	case 1:
    		ContaPoupanca novaContaPoupanca = new ContaPoupanca(
        			...
        			Double.parseDouble(jTextField2.getText()), 
        			Double.parseDouble(jTextField3.getText()));
        	Banco.inserir(novaContaPoupanca);
        	System.out.printf("%s - %s - %s", String.valueOf(novaContaPoupanca.getNumero()),
        			String.valueOf(novaContaPoupanca.getSaldo()),
        			String.valueOf(novaContaPoupanca.getLimite()));
    		break;
    	default:
    		break;  
    	}
